...
export default function WorkflowLogsPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-white/70">Add ?workflowId=&lt;id&gt; to view module status.</p>
      {workflowId ? (
        <div className="rounded-lg border border-zinc-700 bg-zinc-900/70 p-4">
          <h3 className="mb-4 text-sm font-semibold uppercase tracking-wide text-white/90">Module Status</h3>
          <StepTimeline steps={steps.data ?? []} />
        </div>
      ) : (
        <div className="rounded-lg border border-zinc-700 bg-zinc-900/70 p-4 text-sm text-white/70">
